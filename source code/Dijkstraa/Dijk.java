...
// test 1
		...
		Dijk test1 = new Dijk(testing_graph, testing_number_of_vertices);
	...
	public Dijk(int[][] graph, int number_of_vertices) {
	...
	public int findMinDistance() {   //to find shortest distance of unvisited adjacent node
	...
	public void applyAlgorithm(int source) {
		...
		for (int count = 0; count < number_of_vertices - 1; count++) 
		{
				...
				for (int v = 0; v < number_of_vertices; v++) 			// visited[0] is true --> !true --> false no change the
																		// distance
				{
